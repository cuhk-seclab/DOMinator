...
dbox.innerContainer.innerHTML = "<p style='clear: both; margin: 3px 0 0 0;'><img src='" +  this.resourcePrefix + "resources/aardvarkhelp.gif' style=' float: right; margin: 0 0 0px 0'>" + this.strings.initialTipText + "</p>";
...
const selector = aardvark.unique(elem);
if (selector.includes(">")){
  this.labelElem.style.backgroundColor="#ff8a80";
}
else {
  this.labelElem.style.backgroundColor="#fff0cc";
}
string += "<br> Selector: " + aardvark.unique(elem);
...
console.log("[LabelTool] KeyPress: "+c);
...
if (this.doc.aardvarkRunning) {
  ...
  // els = this.doc.getElementsByTagName("iframe");
  // for (el of els){
...
labelSens : function (elem) {
  elem.setAttribute("cpp_protected","1");
  elem.style.backgroundColor = "#8FBC8F";
  elem.style.border="1.5px solid green"
}, 

unlabelSens : function (elem) {
  elem.removeAttribute("cpp_protected");
